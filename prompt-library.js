window.PROMPT_LIBRARY = {
  ...
  "General": [
    ...
    {
      "title": "hour",
      "description": "crumbling brutalist towers, neon reflections on rain-slicked streets, long shadows,"
    },
    {
      "title": "room",
      "description": "bioluminescent coral, shafts of pale light from above, a silhouetted figure on a"
    }
  ]
};
